...
sigma = ones(popsize,discretization_num_T+1,discretization_num_K+1)*0.2;
prices = BSPriceMatrixCreator(S,K_0,K_l,T_0,T_l,discretization_num_K, discretization_num_T,r,sigma,popsize);
...
figure;
surf(K(1:25),T,(squeeze(u(index_best,:,1:25)) - squeeze(prices(index_best,:,1:25)))./squeeze(u(index_best,:,1:25)));
hold on;
