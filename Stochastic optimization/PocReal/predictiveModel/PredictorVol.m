...
inputStructure.epsilon = 0.16; % 0.18 for 10-12-2018 ; 1.3 for 2018-12-24  % Changing it allows to explore different solutions
inputStructure.maxIter = 200;
inputStructure.concentration_weights = 0.04;
inputStructure.discretizationType = 'nonuniform';
...
inputStructure.date = '2018-12-31'; %'2018-11-15', '2018-11-30', '2018-12-24'
inputStructure.optionType = 'C';
inputStructure.r = 0;
inputStructure.includeVolAssumption = 'zero';
