function [isLocalVolValidated] = localVolValidator_1Maturity(inputStructure)
...
[~, T_numeric, S, Vmarket, VolImp] = parseCBOE(inputStructure.marketDataFile, inputStructure.ticker, inputStructure.validationDate, inputStructure.optionType);
