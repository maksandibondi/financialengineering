function [localVolCalibrated] = localVolCalibratorRunner(inputStructure)
...
[localVolCalibrated, diffprice] = calculateLocalVolGenetic(K, T, S, inputStructure.r, Vmarket, VolImp, inputStructure);
return;