...
title('solution eqation 1 part 5 T = 1 initial condition t = 1'); 
...
title('solution eqation 1 part 5 T = 1 boundary condition x = 1');

figure; plot(t,u(:,discretization_num_x + 2), 'b'); xlabel('variable t'); ylabel('variable u');
title('solution eqation 1 part 5 T = 1 boundary condition x = 22'); 
...
title('solution eqation 1 part 5 T = 1');   

display(showsolutionInPoint(0.6, 0.5, u, x_0, delta_x, t_0, delta_t));