...
figure; plot(x, u(discretization_num_t+2,:), 'r'); xlabel('variable t'); ylabel('variable u'); title('solution Problem 3 part 1 T = 0.5 final condition t = MAX');
...
figure; plot(t,u(:,1),'r');  xlabel('variable t'); ylabel('variable u'); title('solution Problem 3 part 1 T = 0.5 boundary condition x = MIN'); 
figure; plot(t,u(:,discretization_num_x + 2), 'b'); xlabel('variable t'); ylabel('variable u'); title('solution Problem 3 part 1 T = 0.5 boundary condition x = MAX');
...
%tnew = (1:101)*t/(101);
figure;
surfl(x,tnew,W,'light'); xlabel('variable x'); ylabel('variable t'); zlabel('function u'); title('solution Problem 3 part 1');   
