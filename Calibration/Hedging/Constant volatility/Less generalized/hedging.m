...
% V0 = BSTheory_put(S0,t_0,T,K,r,sigma); for put
V(1) = V0;
...
for i = 2:discretization_num_t
    ...
    if ismember(i,hedge_array)
        ...
        % A(i) = normal(d1(S(i),t(i),T,K,r,sigma))-1; % New alpha recalculation for put
    ...
    % V(i) = BSTheory_put(S(i),t(i),T,K,r,sigma); % for put
