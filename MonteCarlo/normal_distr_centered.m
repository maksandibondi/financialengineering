function[variance_exp, expv] = normal_distr_centered(num_of_iter, num_of_rand, set_of_x)
...
while i<=sz
    ...
    while k<=num_of_iter    
        ...
        Alpha(i,k) = (Arithmeticmean_ubar-0.5)*(12*num_of_rand)^(0.5); % Looking for alpha
